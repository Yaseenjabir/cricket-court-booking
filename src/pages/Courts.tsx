  ...
  const courts = [
    {
      ...
      image: court1,
      description:
        "Our flagship professional lane with full-size pitch and premium facilities.",
      features: [
        "LED Flood Lights",
        "Professional Nets",
        "Air Conditioned",
    ...
    },
    {
      ...
      image: court2,
      description:
        "Perfect for practice sessions with bowling machine and video analysis.",
      features: [
        "LED Lights",
        "Bowling Machine",
        "Video Analysis",
    ...
    },
    {
      ...
      image: court3,
      description:
        "Full-size match court ideal for team games and tournaments.",
      ...
      <section className="hero-gradient py-16 md:py-24">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-background/80 text-lg max-w-2xl mx-auto">
            5 professional cricket courts equipped with the latest technology
            and maintained to international standards.
          </p>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {courts.map((court) => (
              <div
                key={court.id}
                className="bg-card rounded-xl overflow-hidden shadow-soft hover:shadow-lg transition-all duration-300 group"
              >
          ...
          <div className="max-w-4xl mx-auto">
                ...
                <tbody className="divide-y divide-border">
                  <tr className="hover:bg-muted/50 transition-colors">
                    ...
                    <td className="px-6 py-4">
                      <span className="px-2 py-1 text-xs rounded bg-secondary/20 text-secondary font-medium">
                        Weekday Day
                      </span>
                    </td>
                  ...
                  <tr className="hover:bg-muted/50 transition-colors">
                    ...
                    <td className="px-6 py-4">
                      <span className="px-2 py-1 text-xs rounded bg-primary/20 text-primary font-medium">
                        Weekday Night
                      </span>
                    </td>
                    <td className="px-6 py-4 text-sm text-right font-semibold text-foreground">
                  ...
                  <tr className="hover:bg-muted/50 transition-colors">
                    ...
                    <td className="px-6 py-4">
                      <span className="px-2 py-1 text-xs rounded bg-accent/20 text-accent font-medium">
                        Weekend Day
                      </span>
                    </td>
                    <td className="px-6 py-4 text-sm text-right font-semibold text-foreground">
                  ...
                  <tr className="hover:bg-muted/50 transition-colors">
                    ...
                    <td className="px-6 py-4">
                      <span className="px-2 py-1 text-xs rounded bg-warning/20 text-warning font-medium">
                        Weekend Night
                      </span>
                    </td>
                    <td className="px-6 py-4 text-sm text-right font-semibold text-foreground">
            ...
            <div className="md:hidden space-y-4">
              <div className="bg-card rounded-xl border p-4">
                ...
                <span className="inline-block px-2 py-1 text-xs rounded bg-secondary/20 text-secondary font-medium">
                  Weekday Day
                </span>
              </div>
              ...
              <div className="bg-card rounded-xl border p-4">
                ...
                <span className="inline-block px-2 py-1 text-xs rounded bg-primary/20 text-primary font-medium">
                  Weekday Night
                </span>
              </div>
              ...
              <div className="bg-card rounded-xl border p-4">
                ...
                <span className="inline-block px-2 py-1 text-xs rounded bg-accent/20 text-accent font-medium">
                  Weekend Day
                </span>
              </div>
              ...
              <div className="bg-card rounded-xl border p-4">
                ...
                <span className="inline-block px-2 py-1 text-xs rounded bg-warning/20 text-warning font-medium">
                  Weekend Night
                </span>
              </div>
            </div>
